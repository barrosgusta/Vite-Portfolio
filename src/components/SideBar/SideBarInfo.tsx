...
import { faMailBulk, faMapLocation, faMobile } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className="grid place-items-center">
            <div className="flex flex-col justify-center items-start">
                <div className="grid grid-flow-col place-items-center">
                    ...
                    <span className="text-white text-xs text-left justify-center">
                        E-Mail: guga082011@gmail.com
                    </span>
                </div>

                <div className="grid grid-flow-col place-items-center">
                    <IconFrame icon={<FontAwesomeIcon icon={faMapLocation} />} />
                    <span className="text-white text-xs text-left justify-center">
                        Rio do Sul - SC
                    </span>
                </div>
            ...
            <div className="border border-slate-500 w-24 h-0 my-2 flex flex-col items-center justify-center"></div>
